    ...
    <div className="py-16 overflow-hidden bg-gray-50 lg:py-24">
      <div className="relative max-w-xl px-4 mx-auto sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <div className="relative">
          <h2 className="text-3xl font-bold leading-8 tracking-tight text-center text-green-600 sm:text-4xl">
        ...
        <div className="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:items-center lg:gap-8">
          ...
          <div className="relative mt-10 -mx-4 lg:mt-0" aria-hidden="true">
            ...
            <img
              ...
              width={490}
              src="https://ik.imagekit.io/binwwyjjg/kooballo/adaptive-icon.png?updatedAt=1683984041726"
              alt=""
            />
          </div>
        </div>
